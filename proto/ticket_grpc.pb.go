...
const (
	...
	TicketService_GetUsersBySection_FullMethodName = "/ticket.TicketService/GetUsersBySection"
...
func (c *ticketServiceClient) GetUsersBySection(ctx context.Context, in *SectionRequest, opts ...grpc.CallOption) (*SectionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedTicketServiceServer) GetUsersBySection(context.Context, *SectionRequest) (*SectionResponse, error) {
